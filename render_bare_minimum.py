...
app = FastAPI(title="PriceOptima API - Bare Minimum", version="1.0.0")
...
MAX_ROWS = 2000  # Limit to 2k rows max
...
@app.get("/")
async def root():
    return {"message": "PriceOptima API - Bare Minimum", "status": "running"}
...
async def run_eda():
    ...
    try:
        ...
        # Basic EDA - avoid heavy computations
